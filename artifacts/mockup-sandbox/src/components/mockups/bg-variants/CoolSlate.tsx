  ...
  return (
    <div style={{ background: BG, minHeight: "100vh", color: TEXT, fontFamily: "Inter, sans-serif", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 280, zIndex: 0, overflow: "hidden" }}>
        ...
        <div style={{ position: "absolute", inset: 0, background: `linear-gradient(to bottom, rgba(9,12,18,0.2) 0%, rgba(9,12,18,0.5) 50%, rgba(9,12,18,1) 100%)` }} />
      </div>
      ...
      <div style={{ padding: "220px 20px 24px", position: "relative", zIndex: 5 }}>
        ...
        <div style={{ textAlign: "center", padding: "12px 0 4px" }}>
          <div style={{ display: "inline-block", background: `rgba(9,12,18,0.8)`, border: `1px solid ${GOLD}`, borderRadius: 20, padding: "6px 16px", fontSize: 11, color: GOLD, fontWeight: 600 }}>
            ② Cool Slate — #090c12
          </div>
        </div>
      </div>
