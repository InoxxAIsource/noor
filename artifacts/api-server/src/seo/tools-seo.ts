...
<div class="cta-box" style="margin:24px 0">
  ...
  <a href="/download" class="cta-btn">Open Zakat Calculator in Noor →</a>
</div>
...
router.get("/masjid-finder", (_req: Request, res: Response) => {
  const faqs = [
    { q: "How do I find a mosque near me?", a: "Open Noor app and tap Masjid Finder. It uses your GPS location to find all mosques within 5km and shows distance and navigation." },
    { q: "Does the Noor masjid finder show Shia mosques?", a: "Yes, Noor shows all types of mosques from OpenStreetMap. You can filter by All, Sunni, Shia, or Jama Masjid." },
    ...
    { q: "How accurate is the mosque finder?", a: "Noor uses the OpenStreetMap Overpass API which has over 500,000 mosques worldwide." },
  ];
...
router.get("/qibla-direction", (_req: Request, res: Response) => {
  const faqs = [
    ...
    { q: "How do I find Qibla direction at home?", a: "Open Noor app and tap Qibla Compass. It uses your GPS and device compass to show the exact Qibla direction with an animated compass needle." },
    ...
    { q: "Can I find Qibla without internet?", a: "Yes, Noor app calculates Qibla using mathematical bearing from your GPS coordinates — no internet needed for the calculation." },
  ];
...
router.get("/ramadan", (_req: Request, res: Response) => {
  ...
  const head = seoHead({
    ...
    canonical: "/ramadan",
    schema: [
      { "@context": "https://schema.org", "@type": "Article", "headline": "Ramadan 2026 India Guide", "description": "Complete guide to Ramadan 2026 in India including start date, sehri-iftar times, and duas.", "author": { "@type": "Organization", "name": "Noor App" } },
      faqSchema(faqs),
    ],
  });
...
router.get("/islamic-calendar/2026", (_req: Request, res: Response) => {
  ...
  const head = seoHead({
    ...
    schema: { "@context": "https://schema.org", "@type": "Article", "headline": "Islamic Calendar 2026 India", "description": "Complete Islamic calendar 2026 with Hijri dates and all major Islamic events.", "author": { "@type": "Organization", "name": "Noor App" } },
  });
