...
router.get("/best-muslim-prayer-app-india", (_req: Request, res: Response) => {
  ...
  const faqs = [
    { q: "What is the best free Muslim prayer app in India?", a: "Noor is the best free Muslim prayer app in India in 2026. It offers prayer times for 80+ cities, Quran with audio, AI Islamic guide, and no ads — all completely free." },
    { q: "Is Noor better than Muslim Pro?", a: "Noor has unique features that Muslim Pro lacks: AI Islamic guide, khushoo journal, live prayer rooms, Islamic baby names finder, and guided audio sessions. Unlike Muslim Pro, Noor is completely free with no ads." },
    { q: "Does Noor work without internet?", a: "Core features like Quran reading, duas, tasbih, and salah guide work offline. Prayer times, AI guide, and masjid finder require internet." },
    { q: "Is Noor app free?", a: "Yes, Noor is completely free with no ads, no subscription, and no premium tier. All features are available to all users." },
    { q: "Is Noor available for iPhone?", a: "Noor is a Progressive Web App (PWA) that works on any device — iPhone, Android, or desktop — through your browser. No app store download needed." },
  ];
  ...
  const itemListSchema = {
    ...
    "itemListElement": [
      { "@type": "ListItem", "position": 1, "name": "Noor", "url": "https://noorapp.com" },
      { "@type": "ListItem", "position": 2, "name": "Muslim Pro", "url": "https://noorapp.com/best-muslim-prayer-app-india" },
      { "@type": "ListItem", "position": 3, "name": "WeMuslim", "url": "https://noorapp.com/best-muslim-prayer-app-india" },
      { "@type": "ListItem", "position": 4, "name": "Athan", "url": "https://noorapp.com/best-muslim-prayer-app-india" },
    ],
  };

  const head = seoHead({
    title: "Best Muslim Prayer App in India 2026 — Ranked & Compared",
    description: "Comparison of the best Muslim prayer apps in India 2026: Noor vs Muslim Pro vs WeMuslim vs Athan. Features, price, and honest review.",
...
<div class="card" style="margin:24px 0;border-color:rgba(255,215,0,0.4);background:rgba(255,215,0,0.03)">
  <div style="display:flex;align-items:center;gap:12px;margin-bottom:8px">
    ...
    <span style="font-family:Cinzel,serif;font-size:1.2rem;color:#ffd700">Noor</span>
  </div>
...
<div style="overflow-x:auto;margin:16px 0">
  <table style="width:100%;border-collapse:collapse;font-size:14px">
    <tr style="border-bottom:1px solid rgba(0,165,80,0.3)">
      ...
      <th style="padding:10px 12px;color:#00a550;min-width:120px">Noor ★</th>
