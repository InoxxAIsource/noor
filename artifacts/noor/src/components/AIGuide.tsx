  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      if (res.status === 429 || data.error) {
        setMessages([...newMessages, { role: "assistant", content: data.error || "Daily limit reached. JazakAllah khair for using MyTazki!" }]);
        setRemaining(0);
      } else if (data.reply) {
          ...
          <div className="relative bg-[var(--bg)] rounded-t-3xl flex flex-col" style={{ height: "80vh" }}>
            ...
            <div className="flex items-center justify-between p-4 border-b border-[var(--border)] shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-cinzel text-[var(--gold)] text-base leading-tight">MyTazki Guide</h3>
